...
class SimpleAgent(BaseAgent):
    def __init__(self, name: str):
        ...
        ### auch andere Sepzifikationen möglich, um das zu garantieren,
    ...
    def on_quote(self, market_id: str, book_state: pd.Series):
        ...
        # cancel old orders, müsst ihr entscheiden, ob er immer neu quoten soll, oder nur manchmal:
        ...
        if self.market_interface.exposure_left >= 50000:
            #if we don't have quotable Spread, don´t submitt new and cancel old:
            if self.spread_market[market_id] > self.max_spread_quoted:
                #go out of the market of this Share:
            ...
            #####  hier die Strategie rein #####
            ####################################

        #less exposure than 95% left, sell everything:
        else:
...
if __name__ == "__main__":
    ...
    backtest.run_episode_generator(identifier_list=identifier_list,
        ...
        episode_buffer=15,  ## 15
        episode_length=75,  ## 75               ## length - buffer = traiding time of the agent
        num_episodes=10,   ## 10
        seed = 5,
    )
